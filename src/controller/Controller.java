...
=======
				...
				case 2:
					...
					{
						view.printMessage("\n No se encontró ningun comparendo con la localidad "+loc);
>>>>>>> 83da47a5771afc9e118dafa558c066ac97a791ab
					}
					else
					{
						view.printMessage("\n Primer comparendo con la localidad "+loc+" es:");
...
<<<<<<< HEAD
			...
			case 7:
				view.printMessage("--------- \nComparación de comparendos por Infracción en servicio Particular y servicio Público");
				ListaEncadenada<Linea> lista2 = new ListaEncadenada<Linea>();
				view.printMessage("\nInfracción\tParticular\tPúblico\t");
				NodoLista<Linea> nod = lista2.darPrimero();
				for(int i = 0; i < lista2.darTamano(); i++)
				{
			...
			case 8:
				...
				for(int i = 0; i < localidades.length; i ++){
					ListaEncadenada a = modelo.darComparendosXLocalidad(localidades[i]);
					int j = a.darTamano();
